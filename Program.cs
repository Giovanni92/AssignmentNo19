    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var listOfEmployees = new List<Employees>
            {
                ...
                new Employees { EmployeeID=1150, FirstName="Giovanni",LastName="Desiderio", Salary=7000, Age=28,Appraisal = new List<int>{8,7,8,7,8} }
            };
            ...
            filteredList = (from emp in listOfEmployees
                            ...
                            select emp).ToList();
            Employees.DisplayWithAppraisal(filteredList, "Salary higher than 6000 and age above 40",true);
            ...
            //Apparisal less than 8 and salary greater than  4000
            filteredList = (from emp in listOfEmployees
                            where emp.Salary > 40000 && emp.Appraisal[0] < 8
                            select emp).ToList();
            Employees.DisplayWithAppraisal(filteredList, "Apparisal less than 8 and salary greater than 40000", true);
